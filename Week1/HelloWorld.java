...
public class HelloWorld extends PApplet
{
	...
	/** The map you will use to display your home town: Los Angeles, CA */ 
	UnfoldingMap map2;

	public void setup() {
		
		size(1000, 800, P2D);  // Set up the Applet window to be 800x600
		...
		map1 = new UnfoldingMap(this, 50, 100, 350, 500, provider);
		map2 = new UnfoldingMap(this, 450, 100, 350, 500, provider2);
		
		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
	    map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
	    map2.zoomAndPanTo(zoomLevel, new Location(34.0f, -118.2f));
